...
const char descriptor_table_protodef_friend_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "viceRpc\022M\n\016rGetFriendList\022\034.fixbug.GetFr"
...
void FriendServiceRpc::rGetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
                         const ::fixbug::GetFriendListRequest*,
                         ::fixbug::GetFriendListResponse*,
                         ::google::protobuf::Closure* done) {
  controller->SetFailed("Method rGetFriendList() not implemented.");
  done->Run();
}
...
void FriendServiceRpc_Stub::rGetFriendList(::PROTOBUF_NAMESPACE_ID::RpcController* controller,
