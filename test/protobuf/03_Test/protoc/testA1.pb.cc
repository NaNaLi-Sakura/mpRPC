...
extern PROTOBUF_INTERNAL_EXPORT_testA1_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode_testA1_2eproto;
extern PROTOBUF_INTERNAL_EXPORT_testA1_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_testA1_2eproto;
namespace fixbug {
...
static void InitDefaultsscc_info_GetFriendListRequest_testA1_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_GetFriendListRequest_testA1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_GetFriendListRequest_testA1_2eproto}, {}};

static void InitDefaultsscc_info_GetFriendListResponse_testA1_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<2> scc_info_GetFriendListResponse_testA1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 2, 0, InitDefaultsscc_info_GetFriendListResponse_testA1_2eproto}, {
      &scc_info_ResultCode_testA1_2eproto.base,
      &scc_info_User_testA1_2eproto.base,}};

static void InitDefaultsscc_info_LoginRequest_testA1_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LoginRequest_testA1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LoginRequest_testA1_2eproto}, {}};

static void InitDefaultsscc_info_LoginResponse_testA1_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_LoginResponse_testA1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_LoginResponse_testA1_2eproto}, {}};

static void InitDefaultsscc_info_ResultCode_testA1_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_ResultCode_testA1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_ResultCode_testA1_2eproto}, {}};

static void InitDefaultsscc_info_User_testA1_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_User_testA1_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_User_testA1_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_testA1_2eproto[6];
static const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* file_level_enum_descriptors_testA1_2eproto[1];
static const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* file_level_service_descriptors_testA1_2eproto[1];

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_testA1_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResponse, retcode_),
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 15, -1, sizeof(::fixbug::GetFriendListRequest)},
  { 21, -1, sizeof(::fixbug::User)},
  { 29, -1, sizeof(::fixbug::ResultCode)},
  { 36, -1, sizeof(::fixbug::GetFriendListResponse)},
};
...
const char descriptor_table_protodef_testA1_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014testA1.proto\022\006fixbug\".\n\014LoginRequest\022\014"
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_testA1_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_testA1_2eproto_sccs[6] = {
  &scc_info_GetFriendListRequest_testA1_2eproto.base,
  &scc_info_GetFriendListResponse_testA1_2eproto.base,
  &scc_info_LoginRequest_testA1_2eproto.base,
  &scc_info_LoginResponse_testA1_2eproto.base,
  &scc_info_ResultCode_testA1_2eproto.base,
  &scc_info_User_testA1_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_testA1_2eproto_once;
static bool descriptor_table_testA1_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_testA1_2eproto = {
  &descriptor_table_testA1_2eproto_initialized, descriptor_table_protodef_testA1_2eproto, "testA1.proto", 578,
  &descriptor_table_testA1_2eproto_once, descriptor_table_testA1_2eproto_sccs, descriptor_table_testA1_2eproto_deps, 6, 0,
  schemas, file_default_instances, TableStruct_testA1_2eproto::offsets,
  file_level_metadata_testA1_2eproto, 6, file_level_enum_descriptors_testA1_2eproto, file_level_service_descriptors_testA1_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_testA1_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_testA1_2eproto), true);
namespace fixbug {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* User_Sex_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_testA1_2eproto);
  return file_level_enum_descriptors_testA1_2eproto[0];
}
...
void LoginRequest::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginRequest_testA1_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  password_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
void LoginResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_LoginResponse_testA1_2eproto.base);
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
const GetFriendListRequest& GetFriendListRequest::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_GetFriendListRequest_testA1_2eproto.base);
  return *internal_default_instance();
}
...
void User::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_User_testA1_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
...
void ResultCode::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_ResultCode_testA1_2eproto.base);
  errmsg_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  errcode_ = 0;
}
...
void GetFriendListResponse::InitAsDefaultInstance() {
  ::fixbug::_GetFriendListResponse_default_instance_._instance.get_mutable()->retcode_ = const_cast< ::fixbug::ResultCode*>(
      ::fixbug::ResultCode::internal_default_instance());
}
class GetFriendListResponse::_Internal {
 public:
  static const ::fixbug::ResultCode& retcode(const GetFriendListResponse* msg);
};

const ::fixbug::ResultCode&
GetFriendListResponse::_Internal::retcode(const GetFriendListResponse* msg) {
  return *msg->retcode_;
}
...
GetFriendListResponse::GetFriendListResponse(const GetFriendListResponse& from)
  ...
  if (from._internal_has_retcode()) {
    retcode_ = new ::fixbug::ResultCode(*from.retcode_);
  } else {
    retcode_ = nullptr;
  }
...
void GetFriendListResponse::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_GetFriendListResponse_testA1_2eproto.base);
  retcode_ = nullptr;
}
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListResponse)
  ...
  if (from.has_retcode()) {
    _internal_mutable_retcode()->::fixbug::ResultCode::MergeFrom(from._internal_retcode());
  }
}
...
const ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor* UserServiceRpc::descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_testA1_2eproto);
  return file_level_service_descriptors_testA1_2eproto[0];
}
...
void UserServiceRpc::CallMethod(const ::PROTOBUF_NAMESPACE_ID::MethodDescriptor* method,
                             ...
                             ::google::protobuf::Closure* done) {
  GOOGLE_DCHECK_EQ(method->service(), file_level_service_descriptors_testA1_2eproto[0]);
  switch(method->index()) {
    case 0:
      Login(controller,
