...
#ifndef GOOGLE_PROTOBUF_INCLUDED_testA1_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_testA1_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_testA1_2eproto
...
struct TableStruct_testA1_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_testA1_2eproto;
namespace fixbug {
...
class ResultCode :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ...
    return ::descriptor_table_testA1_2eproto.file_level_metadata[kIndexInFileMessages];
  }
 ...
 private:
  ...
  friend struct ::TableStruct_testA1_2eproto;
};
// -------------------------------------------------------------------
...
class GetFriendListResponse :
 ...
 public:
  ...
  public:
  void clear_retcode();
  const ::fixbug::ResultCode& retcode() const;
  ::fixbug::ResultCode* release_retcode();
  ::fixbug::ResultCode* mutable_retcode();
  void set_allocated_retcode(::fixbug::ResultCode* retcode);
  private:
  const ::fixbug::ResultCode& _internal_retcode() const;
  ::fixbug::ResultCode* _internal_mutable_retcode();
  public:
...
// .fixbug.ResultCode retcode = 1;
inline bool GetFriendListResponse::_internal_has_retcode() const {
  return this != internal_default_instance() && retcode_ != nullptr;
}
inline bool GetFriendListResponse::has_retcode() const {
  return _internal_has_retcode();
}
inline void GetFriendListResponse::clear_retcode() {
  if (GetArenaNoVirtual() == nullptr && retcode_ != nullptr) {
    delete retcode_;
  }
  retcode_ = nullptr;
}
inline const ::fixbug::ResultCode& GetFriendListResponse::_internal_retcode() const {
  const ::fixbug::ResultCode* p = retcode_;
  return p != nullptr ? *p : *reinterpret_cast<const ::fixbug::ResultCode*>(
      &::fixbug::_ResultCode_default_instance_);
}
inline const ::fixbug::ResultCode& GetFriendListResponse::retcode() const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.retcode)
  return _internal_retcode();
}
inline ::fixbug::ResultCode* GetFriendListResponse::release_retcode() {
  // @@protoc_insertion_point(field_release:fixbug.GetFriendListResponse.retcode)
  
  ::fixbug::ResultCode* temp = retcode_;
  retcode_ = nullptr;
  return temp;
}
inline ::fixbug::ResultCode* GetFriendListResponse::_internal_mutable_retcode() {
...
inline ::fixbug::ResultCode* GetFriendListResponse::mutable_retcode() {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.retcode)
  return _internal_mutable_retcode();
}
inline void GetFriendListResponse::set_allocated_retcode(::fixbug::ResultCode* retcode) {
  ...
  retcode_ = retcode;
  // @@protoc_insertion_point(field_set_allocated:fixbug.GetFriendListResponse.retcode)
}
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_testA1_2eproto
